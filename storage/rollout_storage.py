...
from rsl_rl_ts.utils import split_and_pad_trajectories
...
class RolloutStorage:
    ...
    def __init__(self, num_envs, num_transitions_per_env, obs_shape, critic_obs_shape, privileged_obs_shape, obs_history_shape, actions_shape, device="cuda:0"):
    #def __init__(self, num_envs, num_transitions_per_env, obs_shape, critic_obs_shape ,privileged_obs_shape, obs_history_shape, actions_shape, device="cpu"):
        self.device = device
        ...
        if obs_history_shape[0] is not None:
    ...
    def add_transitions(self, transition: Transition):
        ...
        if self.observation_histories is not None:
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                yield obs_batch, critic_observations_batch, privileged_obs_batch, obs_history_batch, actions_batch, target_values_batch, advantages_batch, returns_batch, old_actions_log_prob_batch, old_mu_batch, old_sigma_batch, (
                    None,
                    None,
                ), None
